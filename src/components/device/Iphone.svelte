...
<div class="flex flex-col gap-4 w-full h-full">
      ...
      <div class="px__screen">
        <div class="px__screen__">
          <div class="px__screen__frame">
            <div
              class="relative flex items-center w-full h-full pt-5"
              style="background-color:{$appDetails.splashColor}"
            >
              {#if $appDetails.icon}
                <div class="flex w-full absolute top-8">
              ...
              {/if}
              <div class="flex flex-col gap-2 mx-auto text-center text-white">
                <div class="flex">
                  <img src={$appDetails.logo} alt="" class="h-12 mx-auto" />
                </div>
                <div class="mx-auto text-center">
                  {#if !$appDetails.logo}
                    <p class="text-sm">Your Ev App Name</p>
                  {/if}
                  <p>
                    {$appDetails.appName}
                  </p>
              ...
              <div class="flex w-full absolute bottom-4 ">
                <div
                  class="flex gap-0.5 text-white items-center mx-auto text-xs"
                >
                  <p>Made with</p>
                  <img src={kazamIcon} alt="" class="h-4 w-auto" />
                  <p>in india.</p>
                </div>
              </div>
            </div>
  ...
  <p class="mx-auto">App Icon Preview</p>
</div>
